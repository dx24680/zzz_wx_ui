                    ...
                    <template v-if="item.son_list && item.son_list.length > 0">
                        ...
                        >
                            <a
                                    ...
                                    :href="`${iframe_host_re}center_re?url=${son_item.url}`"
                                    :data-parentindex="index"
                                    target="iframe_app"
                                    @click="funcUrlClick(index, son_index)"
                            >
                                <div class="son_icon_area">
                                    <div class="son_icon"></div>
                                </div>
...
<style>
    ...
    .m-top_area {
        position: relative;
        width: 100%;
        background: url("https://img.wx.xiao-bo.com/_ftp/a_res_app/php/admin/img.acc/acc_top_menu_bg.jpg") center/cover no-repeat;
    }
